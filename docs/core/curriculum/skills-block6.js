...
export const CURRICULUM_VERSION = "rebuild-block6-phase5-relatives";
const phase5Shared = {
    phase: 5,
    contentKind: "lesson",
    assessed: true,
...
const PHASE5_SKILLS = Object.freeze([
    {
        ...phase5Shared,
...
export const SKILLS = Object.freeze([...PRIOR_SKILLS, ...PHASE5_SKILLS]);
