...
export declare const DEFAULT_SCHEDULER_POLICY: SchedulerPolicy;
export declare function ratingForAttempt(attempt: Pick<LearningAttempt, "outcome" | "independent" | "directEvidence">): SchedulerRating;
