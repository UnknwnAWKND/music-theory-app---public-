...
const CHECKPOINT_GROUPS: Record<number, readonly CompetencyDefinition[]> = {
  1: [
    ...
    group("interval-third-fifth", "3rds, 4ths & 5ths", ["interval.M3", "interval.m3", "interval.P4", "interval.P5"]),
    group("interval-major-minor", "2nds, 6ths & 7ths", ["interval.M2", "interval.m2", "interval.M6", "interval.m6", "interval.M7", "interval.m7"]),
    group("interval-mixed-spelling", "Mixed interval construction & spelling", ["interval.quality-system", "interval.P8", "interval.mixed-core", "interval.spelling"]),
  ],
  2: [
    group("triad-members-chordtones", "Chord members & chord tones", ["triad.members", "melody.chord-tones", "triad.root-vs-bass"]),
