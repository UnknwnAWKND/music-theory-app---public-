...
export function registerLesson(content: LessonContent): void {
  if (content.skillId.startsWith("circle-of-fifths.")) PHASE6_BY_ID.set(content.skillId, content);
...
export function phase6Lessons(): readonly LessonContent[] { return PHASE6_CIRCLE_LESSONS; }
