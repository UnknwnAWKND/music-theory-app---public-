...
export const CURRICULUM_VERSION = "rebuild-block7-phase6-circle-of-fifths" as const;
...
const PHASE6_SKILLS: readonly SkillDefinition[] = Object.freeze([
  {
    ...phase6Shared,
  ...
  },
  {
    ...
    evidence: ["identify", "compare", "apply"],
  ...
  },
  {
    ...
    evidence: ["select", "transform", "apply"],
...
export const SKILLS: readonly SkillDefinition[] = Object.freeze([...PRIOR_SKILLS, ...PHASE6_SKILLS]);
